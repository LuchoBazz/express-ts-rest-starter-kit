...
CREATE TABLE "subscriptions"."subscription_plans" (
    ...
    "subscription_plan_final_price" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    "subscription_plan_currency" VARCHAR(5) NOT NULL,
    "subscription_plan_currency_symbol" VARCHAR(5) NOT NULL,
