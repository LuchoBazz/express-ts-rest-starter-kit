...
import { PermissionEntity } from "../../../src/entities/users/permission.entity";
import {
  createPermissionInteractor,
  deletePermissionInteractor,
  findPermissionInteractor,
} from "../../../src/interactors/users/permission/permission.interactor";
import { genRandomPermissionPrisma } from "../../mocks/users/permission.mock";

const disconnectMock = jest.fn();

jest.mock("../../../src/services/users/permission.service", () => {
  return {
