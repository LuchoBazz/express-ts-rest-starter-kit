        ...
        <div className="flex items-start">
          <div className="flex-grow truncate">
            ...
            <div className="flex items-center ml-3">
              <span className="text-xs text-gray-400">Started 02/10/2025, 10:01 AM</span>
            </div>
          </div>
          <div className="flex flex-col mt-auto gap-2">
            <button className="cursor-pointer flex gap-1.5 items-center text-left text-xs font-medium text-indigo-100 hover:text-white group focus:outline-none focus-visible:border-b focus-visible:border-indigo-100">
